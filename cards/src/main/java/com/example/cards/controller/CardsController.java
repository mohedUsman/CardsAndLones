...
public class CardsController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponceDto> createCard(@RequestParam String mobileNumber){
        cardsService.cratedCard(mobileNumber);
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> getcardByMobileNumber(@RequestParam String mobileNumber) {
        CardsDto cardsDto = cardsService.getCardByMobileNumber(mobileNumber);
    ...
    @PutMapping("/update")
    public ResponseEntity<ResponceDto> updatedCard(@RequestBody CardsDto cardsDto) {
    ...
    public ResponseEntity<ResponceDto> deleteCard(@RequestParam String mobileNumber){
